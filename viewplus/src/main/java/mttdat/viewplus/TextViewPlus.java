...
public class TextViewPlus extends AppCompatTextView {
    ...
    private float DEFAULT_CUSTOM_SIZE_PT = 20f;

    private float DEFAULT_CUSTOM_SIZE_PX = 39f;
    ...
    private void setCustomSize(Context ctx, AttributeSet attrs) {
        ...
        customSizePx = a.getFloat(R.styleable.TextViewPlus_customSizePx, DEFAULT_CUSTOM_SIZE_PX);
        customSizePt = a.getFloat(R.styleable.TextViewPlus_customSizePt, DEFAULT_CUSTOM_SIZE_PT);
    ...
    public boolean setCustomFont(Context ctx, String asset,boolean has) {
        Typeface tf = null;
        try {
            tf = Typeface.createFromAsset(ctx.getAssets(), asset);
        } catch (Exception e) {
